public class PESIT extends College {

            int numberOfDepartments;
            int numberOfFaculty;

             public PESIT(Principal principal,HOD[] hod, Professors[] professors, Students[] students,int numberOfDepartments, int numberOfFaculty) {
